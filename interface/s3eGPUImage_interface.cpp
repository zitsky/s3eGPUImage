...
typedef       void(*s3eRegisterGlGenTexturesCB_t)(s3eGPUImageGlGenTextures cb);
...
typedef struct s3eGPUImageFuncs
{
    ...
    s3eRegisterGlGenTexturesCB_t m_s3eRegisterGlGenTexturesCB;
} s3eGPUImageFuncs;
...
{
    IwTrace(GPUIMAGE_VERBOSE, ("calling s3eGPUImage[3] func: s3eRegisterGlGenTexturesCB"));
    ...
    g_Ext.m_s3eRegisterGlGenTexturesCB(cb);
